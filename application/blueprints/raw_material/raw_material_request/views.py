...
def add():
    ...
    if request.method == "POST":
        ...
        form.checked_by = "MARIO D. SINGAYAN"
...
def print(record_id):   
    ...
    context["header_positions"] = [
        ("delivery_receipt_number", Position(left=172, top=9, font_size=13)),
        ("customer_name", Position(left=20, top=33, font_size=18)),
        ("formatted_record_date_dr", Position(left=149, top=33, font_size=13)),
        ("delivery_address", Position(left=26, top=39, font_size=11)),
        ("so_number", Position(left=149, top=36, font_size=13)),
        ("po_number", Position(left=149, top=40, font_size=13)),
        ("truck_number", Position(left=57, top=47, font_size=13)),
        ("terms", Position(left=149, top=45, font_size=13)),
        ("articles", Position(left=22, top=58)),
        ("salesman", Position(left=23, top=118)),
        ("prepared_by", Position(left=13, top=129)),
        ("checked_by", Position(left=83, top=129)),
        ("approved_by", Position(left=143, top=129)),
    ]
